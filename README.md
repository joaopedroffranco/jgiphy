...
We would like you to write code that will cover the functionality listed below and provide us with the source as well as the output of an iOS app that consists of two screens:
...
- Use the following API Key: `c2zhJAWwvZMMBJ0qP3RzlobjO1zKjagh`
